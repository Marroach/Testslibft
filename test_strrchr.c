...
int main() {
    ...
    // Test case 2: Needle not present in haystack
    ...
    // Test case 5: Needle longer than the specified length
    ...
    // Test case 6: Full match with len limit
    ...
    // Test case 7: Match at the end of haystack
